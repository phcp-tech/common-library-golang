...
// clickhousenativeInitDefault is the InitDefault implementation used by loadFromEnv.
// It is a package-level variable so that tests can replace it with a stub.
var clickhousenativeInitDefault = clickhousenative.InitDefault
...
func loadFromEnv() error {
	config := &clickhousenative.Config{
	...
	if err := clickhousenativeInitDefault(config); err != nil {
