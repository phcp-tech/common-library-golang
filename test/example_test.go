...
// TestNewHttpExpect demonstrates how to use NewHttpExpect to test an HTTP handler
// without starting a real server. Copy this pattern into your own _test.go files.
//
